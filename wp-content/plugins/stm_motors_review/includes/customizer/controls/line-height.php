...
if ( ! class_exists( 'STM_Customizer_Review_Line_Height_Control' ) ) {

	class STM_Customizer_Review_Line_Height_Control extends WP_Customize_Control {

		public $type = 'stm-line-height';
		public $units = '';
		public $min = '';
		public $max = '';
		...
		public function render_content() {
			...
			<div id="stm-customize-control-<?php echo esc_attr( $this->id ); ?>" class="stm-customize-control stm-customize-control-<?php echo esc_attr( str_replace( 'stm-', '', $this->type ) ); ?>">
				...
				<div class="stm-form-item">
					<div class="stm-line-height-wrapper stm-form-item stm_input_group">
