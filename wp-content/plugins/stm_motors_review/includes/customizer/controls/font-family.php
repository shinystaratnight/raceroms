...
if ( ! class_exists( 'STM_Customizer_Review_Font_Family_Control' ) ) {

	class STM_Customizer_Review_Font_Family_Control extends WP_Customize_Control {

		public $type = 'stm-font-family';
