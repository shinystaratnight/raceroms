    ...
    function stm_input($args = array())
    {
        ...
        switch ($input['type']) {
            ...
            case 'socials' : ?>
                ...
                <input type="hidden" <?php echo apply_filters('stm_mr_props_a', $input_props['data']); ?> value=""/>
            ...
            case 'multiple-checkbox' : ?>
                ...
                <input type="hidden" <?php echo apply_filters('stm_mr_props_b', $input_props['data']); ?>
