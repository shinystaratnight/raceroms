...
define('STM_REVIEW_CUSTOMIZER_PATH', dirname(__FILE__));
define('STM_REVIEW_CUSTOMIZER_URI', plugins_url( '', __FILE__ ));
define('STM_REVIEW_VESRION', '1.0');

if (!class_exists('STM_Customizer_Review')) {
    class STM_Customizer_Review
    {
        ...
        {
            require_once STM_REVIEW_CUSTOMIZER_PATH . '/google-fonts.php';
            require_once STM_REVIEW_CUSTOMIZER_PATH . '/registration.php';
        ...
        public static function stm_enqueue_custom_fonts()
        {
            ...
            wp_enqueue_style('stm-google-fonts', $request, array(), STM_REVIEW_VESRION);
        }
        ...
        public static function load_controls()
        {
            ...
            require_once STM_REVIEW_CUSTOMIZER_PATH . '/controls/input_controller.php';
            require_once STM_REVIEW_CUSTOMIZER_PATH . '/controls/checkbox.php';
            require_once STM_REVIEW_CUSTOMIZER_PATH . '/controls/multiple-checkbox.php';
            require_once STM_REVIEW_CUSTOMIZER_PATH . '/controls/code.php';
            require_once STM_REVIEW_CUSTOMIZER_PATH . '/controls/heading.php';
            require_once STM_REVIEW_CUSTOMIZER_PATH . '/controls/select.php';
            require_once STM_REVIEW_CUSTOMIZER_PATH . '/controls/select-icons.php';
            require_once STM_REVIEW_CUSTOMIZER_PATH . '/controls/post-type.php';
            require_once STM_REVIEW_CUSTOMIZER_PATH . '/controls/separator.php';
            require_once STM_REVIEW_CUSTOMIZER_PATH . '/controls/text.php';
            require_once STM_REVIEW_CUSTOMIZER_PATH . '/controls/font-family.php';
            require_once STM_REVIEW_CUSTOMIZER_PATH . '/controls/attr.php';
            require_once STM_REVIEW_CUSTOMIZER_PATH . '/controls/font-weight.php';
            require_once STM_REVIEW_CUSTOMIZER_PATH . '/controls/icon-picker.php';
            require_once STM_REVIEW_CUSTOMIZER_PATH . '/controls/slider.php';
            require_once STM_REVIEW_CUSTOMIZER_PATH . '/controls/socials.php';
            require_once STM_REVIEW_CUSTOMIZER_PATH . '/controls/bg.php';

        }

        public static function admin_scripts()
        {
            wp_enqueue_style('review-customizer.css', STM_REVIEW_CUSTOMIZER_URI . '/assets/css/customizer.css', array('wp-color-picker'), STM_REVIEW_VESRION, 'all');
        }

        public static function customizer_preview_scripts()
        {
            wp_enqueue_script('review-customizer-preview.js', STM_REVIEW_CUSTOMIZER_URI . '/assets/js/customizer-preview.js', array('jquery', 'customize-preview'), STM_REVIEW_VESRION, true);
        }
        ...
        public static function admin_enqueue_scripts()
        {
            ...
            wp_enqueue_script('review-customizer.js', STM_REVIEW_CUSTOMIZER_URI . '/assets/js/customizer.js', array('customize-controls', 'wp-color-picker'), STM_REVIEW_VESRION, true);
            ...
            switch ($field_data['type']) {
                ...
                case 'stm-bg':
                    self::$customizer->add_control(
                        new STM_Customizer_Review_Bg_Control(
                            self::$customizer,
                            $field,
                            $field_data
                        )
                ...
                case 'stm-attr':
                    self::$customizer->add_control(
                        new STM_Customizer_Review_Attr_Control(
                            self::$customizer,
                            $field,
                            $field_data
                        )
                ...
                case 'stm-socials':
                    self::$customizer->add_control(
                        new STM_Customizer_Review_Socials_Control(
                            self::$customizer,
                            $field,
                            $field_data
                        )
                ...
                case 'stm-multiple-checkbox':
                    self::$customizer->add_control(
                        new STM_Customizer_Review_Multiple_Checkbox_Control(
                            self::$customizer,
                            $field,
                            $field_data
                        )
                ...
                case 'stm-slider':
                    self::$customizer->add_control(
                        new STM_Customizer_Review_Slider_Control(
                            self::$customizer,
                            $field,
                            $field_data
                        )
                ...
                case 'stm-icon-picker':
                    self::$customizer->add_control(
                        new STM_Customizer_Review_Icon_Picker_Control(
                            self::$customizer,
                            $field,
                            $field_data
                        )
                ...
                case 'stm-font-weight':
                    self::$customizer->add_control(
                        new STM_Customizer_Review_Font_Weight_Control(
                            self::$customizer,
                            $field,
                            $field_data
                        )
                ...
                case 'stm-font-family':
                    self::$customizer->add_control(
                        new STM_Customizer_Review_Font_Family_Control(
                            self::$customizer,
                            $field,
                            $field_data
                        )
                ...
                case 'stm-post-type':
                    self::$customizer->add_control(
                        new STM_Customizer_Review_Post_Type_Control(
                            self::$customizer,
                            $field,
                            $field_data
                        )
                ...
                case 'stm-separator':
                    self::$customizer->add_control(
                        new STM_Customizer_Review_Separator_Control(
                            self::$customizer,
                            $field,
                            $field_data
                        )
                ...
                case 'stm-select-icons':
                    self::$customizer->add_control(
                        new STM_Customizer_Review_Select_Icons_Control(
                            self::$customizer,
                            $field,
                            $field_data
                        )
                ...
                case 'stm-checkbox':
                    self::$customizer->add_control(
                        new STM_Customizer_Review_Checkbox_Control(
                            self::$customizer,
                            $field,
                            $field_data
                        )
                ...
                case 'stm-heading':
                    self::$customizer->add_control(
                        new STM_Customizer_Review_Heading_Control(
                            self::$customizer,
                            $field,
                            $field_data
                        )
                ...
                case 'stm-code':
                    self::$customizer->add_control(
                        new STM_Customizer_Review_Code_Control(
                            self::$customizer,
                            $field,
                            $field_data
                        )
                ...
                case 'stm-select':
                    self::$customizer->add_control(
                        new STM_Customizer_Review_Select_Control(
                            self::$customizer,
                            $field,
                            $field_data
                        )
                ...
                case 'stm-text':
                    self::$customizer->add_control(
                        new STM_Customizer_Review_Text_Control(
                            self::$customizer,
                            $field,
                            $field_data
                        )
	...
	STM_Customizer_Review::get_instance();
