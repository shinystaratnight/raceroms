 ...
 * @return bool|int
 */
function butterbean_review_validate_boolean( $value ) {
 ...
 * @return string
 */
function butterbean_review_sanitize_hex_color( $color ) {
 ...
 * @return string
 */
function butterbean_review_sanitize_hex_color_no_hash( $color ) {
	...
	return butterbean_review_sanitize_hex_color( '#' . $color ) ? $color : null;
}
 ...
 * @return string
 */
function butterbean_review_maybe_hash_hex_color( $color ) {

	if ( function_exists( 'maybe_hash_hex_color' ) )
		return maybe_hash_hex_color( $color );

	if ( $unhashed = butterbean_review_sanitize_hex_color_no_hash( $color ) )
		return '#' . $unhashed;
 ...
 * @return void
 */
function butterbean_review_get_manager_template( $slug = '' ) {
	butterbean_review_get_template( 'manager', $slug );
}
 ...
 * @return void
 */
function butterbean_review_get_nav_template( $slug = '' ) {
	butterbean_review_get_template( 'nav', $slug );
}
 ...
 * @return void
 */
function butterbean_review_get_section_template( $slug = '' ) {
	butterbean_review_get_template( 'section', $slug );
}
 ...
 * @return void
 */
function butterbean_review_get_control_template( $slug = '' ) {
	butterbean_review_get_template( 'control', $slug );
}
 ...
 * @return void
 */
function butterbean_review_get_template( $name, $slug = '' ) {
	...
	if ( ! $located ) {
		...
		foreach ( $templates as $template ) {
			...
			if ( file_exists( butterbeanReview()->tmpl_path . $template ) ) {
				$located = butterbeanReview()->tmpl_path . $template;
				break;
			}
		}
	}
