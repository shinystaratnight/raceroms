 ...
 * @access public
 */
class ButterBean_Review_Control_Datetime extends ButterBean_Review_Control {
	...
	public function to_json() {
		...
		$this->json['year'] = array(
			'value' => esc_attr( $year ),
			'label' => esc_html__( 'Year', 'stm_motors_review' ),
		...
		$this->json['month'] = array(
			...
			'label'   => esc_html__( 'Month', 'stm_motors_review' ),
			'choices' => array(
				array(
					'num'   => '',
					'label' => ''
		...
		$this->json['day'] = array(
			...
			'label' => esc_html__( 'Day', 'stm_motors_review' ),
		...
		$this->json['hour'] = array(
			...
			'label' => esc_html__( 'Hour', 'stm_motors_review' ),
		...
		$this->json['minute'] = array(
			...
			'label' => esc_html__( 'Minute', 'stm_motors_review' ),
			'attr'  => 'placeholder="00" size="2" maxlength="2" autocomplete="off"'
		);
		...
		$this->json['second'] = array(
			...
			'label' => esc_html__( 'Second', 'stm_motors_review' ),
			'attr'  => 'placeholder="00" size="2" maxlength="2" autocomplete="off"'
		);
	}
}
