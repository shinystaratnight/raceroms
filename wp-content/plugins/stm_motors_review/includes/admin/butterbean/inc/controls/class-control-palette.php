 ...
 * @access public
 */
class ButterBean_Review_Control_Palette extends ButterBean_Review_Control {
	...
	public function to_json() {
		...
		foreach ( $this->choices as $choice => $palette ) {
			$this->choices[ $choice ]['colors'] = array_map( 'butterbean_review_maybe_hash_hex_color', $palette['colors'] );
