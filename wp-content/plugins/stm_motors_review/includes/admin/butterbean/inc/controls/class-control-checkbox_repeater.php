 ...
 * @access public
 */
class ButterBean_Review_Control_Checkbox_Repeater extends ButterBean_Review_Control {
    ...
    public function __construct( $manager, $name, $args = array() ) {
        ...
        $this->l10n = wp_parse_args(
            $this->l10n,
            array(
                'add_feature'      => esc_html__( 'Add new feature',         'stm_motors_review' ),
                'add'      => esc_html__( 'Add',         'stm_motors_review' ),
                'all'      => esc_html__( 'Show all',         'stm_motors_review' ),
                'remove'      => esc_html__( 'Delete',      'stm_motors_review' ),
            )
        );
    }
