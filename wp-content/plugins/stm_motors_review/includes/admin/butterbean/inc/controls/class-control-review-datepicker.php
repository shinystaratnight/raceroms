 ...
 * @access public
 */
class ButterBean_Review_Control_Review_Datepicker extends ButterBean_Review_Control {
	...
	public function enqueue() {
        wp_enqueue_style('stm_admin_butterbean_datepicker',
            STM_REVIEW_URL . '/assets/css/jquery-ui.min.css',
            false,
            1,
            false);
	}
	...
	public function get_attr() {
		...
		$attr['class']              = 'butterbean-review-datepicker';
		$attr['type']               = 'text';
