 ...
 * @access public
 */
class ButterBean_Review_Control_Image extends ButterBean_Review_Control {
	...
	public function __construct( $manager, $name, $args = array() ) {
		...
		$this->l10n = wp_parse_args(
			...
			array(
				...
				'set'         => esc_html__( 'Set as image',      'stm_motors_review' ),
				'choose'      => esc_html__( 'Choose image',      'stm_motors_review' ),
				'change'      => esc_html__( 'Change image',      'stm_motors_review' ),
				'remove'      => esc_html__( 'Remove image',      'stm_motors_review' ),
				'placeholder' => esc_html__( 'No image selected', 'stm_motors_review' )
			)
		);
	}
