...
( function() {
            ...
            if(inputVal !== '') {
                $.ajax({
                    ...
                    complete: $.proxy(function(data) {
                        ...
                        var currentValue = this.model.attributes.value;
                        var currentValues = this.model.attributes.choices;

                        if(currentValue === '') {
                            currentValue = [];
                        }

                        currentValue.push(data.slug);

                        currentValues[data.slug] = data.name;
    ...
    /*Datepicker*/
    butterbean.views.register_control( 'event-datepicker', {
        events : {
            'click .butterbean-event-datepicker': 'initDatepicker',
        },

        ready: function(){
            jQuery( '.butterbean-event-datepicker' ).datepicker({
                dateFormat: "dd-mm-yy"
            });
        },
    ...
    /*Timepicker*/
    butterbean.views.register_control('timepicker', {
        events: {
            'click .butterbean-timepicker': 'initTimepicker',
        },

        ready: function () {
            jQuery('.butterbean-timepicker').timepicker({});
        },

        initTimepicker: function (m) {
            jQuery(m.currentTarget).timepicker();
        }
    });
