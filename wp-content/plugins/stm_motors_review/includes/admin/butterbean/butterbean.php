...
add_action( 'init', 'butterbean_loader_102', 9999 );

if ( ! function_exists( 'butterbean_loader_102' ) ) {
	 ...
	 * @return void
	 */
	function butterbean_loader_102() {
		...
		if ( ! defined( 'BUTTERBEAN_REVIEW_LOADED' ) ) {
			define( 'BUTTERBEAN_REVIEW_LOADED', true );
