...
if (!class_exists('ButterBeanReview')) {
    /**
    ...
    final class ButterBeanReview
    {
        ...
        private function includes()
        {
            ...
            require_once($this->dir_path . 'inc/controls/class-control-review-datepicker.php');
            require_once($this->dir_path . 'inc/controls/class-control-timepicker.php');
        ...
        private function setup_actions()
        {
            ...
            add_action('butterbean_review_register', array($this, 'register_manager_types'), -95);
            add_action('butterbean_review_register', array($this, 'register_section_types'), -95);
            add_action('butterbean_review_register', array($this, 'register_control_types'), -95);
            add_action('butterbean_review_register', array($this, 'register_setting_types'), -95);
        }

        /**
         * Registration callback. Fires the `butterbean_review_register` action hook to
        ...
        public function register()
        {
            ...
            do_action('butterbean_review_register', $this, $post_type);
        ...
        public function register_manager_types()
        {
            ...
            $this->register_manager_type('default', 'ButterBean_Review_Manager');
        }
        ...
        public function register_section_types()
        {
            ...
            $this->register_section_type('default', 'ButterBean_Review_Section');
        }
        ...
        public function register_control_types()
        {
            ...
            $this->register_control_type('default', 'ButterBean_Review_Control');
            $this->register_control_type('checkboxes', 'ButterBean_Review_Control_Checkboxes');
            $this->register_control_type('color', 'ButterBean_Review_Control_Color');
            $this->register_control_type('datetime', 'ButterBean_Review_Control_Datetime');
            $this->register_control_type('excerpt', 'ButterBean_Review_Control_Excerpt');
            $this->register_control_type('image', 'ButterBean_Review_Control_Image');
            $this->register_control_type('palette', 'ButterBean_Review_Control_Palette');
            $this->register_control_type('radio', 'ButterBean_Review_Control_Radio');
            $this->register_control_type('radio-image', 'ButterBean_Review_Control_Radio_Image');
            $this->register_control_type('select-group', 'ButterBean_Review_Control_Select_Group');
            $this->register_control_type('textarea', 'ButterBean_Review_Control_Textarea');
            $this->register_control_type('multi-avatars', 'ButterBean_Review_Control_Multi_Avatars');
            $this->register_control_type('parent', 'ButterBean_Review_Control_Parent');
            $this->register_control_type('gallery', 'ButterBean_Review_Control_Gallery');
            $this->register_control_type('review-datepicker', 'ButterBean_Review_Control_Review_Datepicker');
			$this->register_control_type('timepicker', 'ButterBean_Review_Control_Timepicker');
            $this->register_control_type('file', 'ButterBean_Review_Control_File');
            $this->register_control_type('repeater', 'ButterBean_Review_Control_Repeater');
            $this->register_control_type('checkbox_repeater', 'ButterBean_Review_Control_Checkbox_Repeater');
            $this->register_control_type('multiselect', 'ButterBean_Review_Control_Multiselect');
        }
        ...
        public function register_setting_types()
        {
            ...
            $this->register_setting_type('default', 'ButterBean_Review_Setting');
            $this->register_setting_type('single', 'ButterBean_Review_Setting');
            $this->register_setting_type('multiple', 'ButterBean_Review_Setting_Multiple');
            $this->register_setting_type('array', 'ButterBean_Review_Setting_Array');
            $this->register_setting_type('datetime', 'ButterBean_Review_Setting_Datetime');
        }
        ...
        public function enqueue()
        {
            ...
            wp_enqueue_script('stm-review-butterbean', $this->dir_uri . "js/stm_review_butterbean_fields.js", array('butterbean'), '', true);

            // Enqueue the main plugin style.
            wp_enqueue_style('butterbean', $this->dir_uri . "css/butterbean{$min}.css");

            wp_enqueue_style('stm-review-butterbean', $this->dir_uri . "css/stm_review_butterbean.css");
        ...
        public function print_templates()
        {
            ...
            <script type="text/html" id="tmpl-butterbean-nav">
                <?php butterbean_review_get_nav_template(); ?>
            </script>
     ...
     * @return object
     */
    function butterbeanReview()
    {
        return ButterBeanReview::get_instance();
    }
